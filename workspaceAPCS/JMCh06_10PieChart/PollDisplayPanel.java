...
/**
 * A PollDisplayPanel holds the vote counts and displays the numbers
 * and the pie chart for the current vote counts.
 *
...
public class PollDisplayPanel extends JPanel
{
     ...
     * Constructor
     * 
     * @param nm1 1st candidate name
     * @param nm2 2nd candidate name
     * @param nm3 3rd candidate name
     */
     ...
     * to count/total, rounded to the nearest integer.
     * 
     * @param count number of votes received
     * @param total total number of votes
     * 
     * @return number of degrees in a pie slice that corresponds
     *         to count/total, rounded to the nearest integer
     *         
     * Note: Should be private. Visibility changed for test purposes only.
     */
    protected int countToDegrees( int count, int total )
    {
    	double tCount = count;
    	double tTotal = total;
        return (int)Math.round((tCount / tTotal) * 360);
    }
     ...
     * @param y y-coordinate of upper left corner of this pie chart
     * @param r radius of inscribed pie chart
     * @param fromDegree starting location of sector
     * @param degrees angle measure of sector
     */
