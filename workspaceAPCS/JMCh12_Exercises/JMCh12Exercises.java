...
public class JMCh12Exercises
{
    ...
    {
        char[] rps = {'r', 'r', 'r', 'p', 'p', 'p', 'p', 'p', 's', 's', 's',
            's', 's', 's'};
    ...
    public String whatDoesMysteryCountCount()
    {
        ...
        String answer = mCount + " consecutive 0's";
        return answer;
    }
    ...
    public static int computeScore( String word )
    {
        ...
        for (int i = 0; i < word.length(); i++) {
            total += letterScores[alphabet.indexOf(String.valueOf(word.charAt(i)).toLowerCase())];
        }
        return total;
    }
